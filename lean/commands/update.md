---
description: Lock in agreed decisions — update doc sections, resolve annotations.
...
Only updates sections where clear agreement exists. Skips contentious threads.
